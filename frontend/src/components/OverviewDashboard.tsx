...
export default function OverviewDashboard({
  ...
  return (
    <div className="flex-1 flex flex-col gap-6 overflow-y-auto pr-1 pb-10">
      {/* Hero Welcome Banner */}
      <div className="p-8 rounded-3xl bg-gradient-to-br from-slate-900/95 via-indigo-950/40 to-slate-950/95 border border-indigo-500/20 backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/15 border border-indigo-500/30 text-indigo-300 text-xs font-semibold uppercase tracking-wider mb-4 shadow-inner">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-md flex flex-col gap-3 group hover:border-indigo-500/40 transition-all">
            ...
            <div>
              ...
              <h4 className="text-sm font-bold text-slate-100 mt-0.5">Vectorize & Chunk</h4>
          ...
          <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-md flex flex-col gap-3 group hover:border-amber-500/40 transition-all">
            ...
            <div>
              ...
              <h4 className="text-sm font-bold text-slate-100 mt-0.5">Audit & Classify</h4>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-md flex flex-col gap-3 group hover:border-emerald-500/40 transition-all">
            ...
            <div>
              ...
              <h4 className="text-sm font-bold text-slate-100 mt-0.5">Copilot Consultation</h4>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-sm">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-1">
            <span>Total Indexed</span>
            <FileText className="w-4 h-4 text-indigo-400" />
          </div>
          <div className="text-2xl font-black text-white">{totalDocs}</div>
          <div className="text-[10px] text-slate-400 mt-0.5">PDF Documents</div>
        </div>

        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-sm">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-1">
            <span>Vector Clauses</span>
            <Layers className="w-4 h-4 text-sky-400" />
          </div>
          <div className="text-2xl font-black text-white">{totalClauses}</div>
          <div className="text-[10px] text-slate-400 mt-0.5">Indexed Embeddings</div>
        </div>

        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-sm">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-1">
            <span>Contracts vs Papers</span>
            <BookOpen className="w-4 h-4 text-amber-400" />
          </div>
          <div className="text-lg font-black text-slate-200 mt-0.5">
            <span className="text-amber-300">{contractsCount}</span> Contracts / <span className="text-sky-300">{nonContractsCount}</span> Docs
          </div>
          <div className="text-[10px] text-slate-400 mt-0.5">Smart Classification</div>
        </div>

        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-sm">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-1">
            <span>High Risk Traps</span>
            <ShieldAlert className="w-4 h-4 text-rose-400" />
          </div>
          <div className="text-2xl font-black text-rose-400">{highRiskCount}</div>
          <div className="text-[10px] text-slate-400 mt-0.5">Hazardous Agreements</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 p-6 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-xl flex flex-col gap-4">
        ...
        <div className="lg:col-span-7 p-6 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-xl flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
              ...
              {recentDocs.map((doc) => {
                ...
                return (
                  <div
                    ...
                    className="p-3.5 rounded-2xl bg-slate-950/50 hover:bg-slate-800/60 border border-slate-800 hover:border-slate-700 transition-all cursor-pointer flex items-center justify-between gap-4 group"
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <h4 className="text-xs font-bold text-slate-200 truncate group-hover:text-indigo-200 transition-colors">
                          {doc.filename}
                        </h4>
                    ...
                    <div className="flex items-center gap-2.5 shrink-0">
                      {isNonContract ? (
                        <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-sky-500/15 text-sky-300 border border-sky-500/20">
                      ...
                      <div className="p-1.5 rounded-lg text-slate-400 group-hover:text-white group-hover:bg-slate-700/60 transition-all">
                        <ArrowRight className="w-3.5 h-3.5" />
                      </div>
                    </div>
                  </div>
